...
class Athena_Simple_Jwt_Authentication_Rest {

	protected $plugin_name;
	protected $plugin_version;
	protected $namespace;
	protected $jwt_namespace;
	...
	public function __construct( $plugin_name, $plugin_version ) {
		...
		$this->jwt_namespace	  = 'simple-jwt-authentication/v1';
	...
	*/
	public function get_levels_pages( $request ) {
		return Athena_Simple_Jwt_Authentication_Api::get_levels_with_pages();
	}

	public function get_user_levels( $request ) {
		return Athena_Simple_Jwt_Authentication_Api::get_user_levels($request['id']);
	}

	public function get_user_levels_pages( $request ) {
		return Athena_Simple_Jwt_Authentication_Api::get_user_levels_pages($request['id']);
	}
	...
	*/
	...
	public function generate_token( $request ) {
		...
		$user_ip    = Athena_Simple_Jwt_Authentication_Api::get_ip();
		$jwt_data[] = array(
			'uuid'      => $uuid,
			'issued_at' => $issued_at,
			'expires'   => $expire,
...
new Athena_Simple_Jwt_Authentication_Rest( $plugin_name, $plugin_version );
